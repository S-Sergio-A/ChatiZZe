  ...
  return (
    <div className="Info-Page Grid">
      ...
      <article className="B-M Nunito flex J-C-S-B A-I-F-S f-f-c-n">
        ...
        <ul className="Po-L">
          ...
          <li>
            <p>Communicate with you, either directly or through one of our partners,
              ...
              and for marketing and promotional purposes;</p>
          </li>
          <li>
            <p>Send you emails;</p>
          </li>
        ...
        <h3>Log Files</h3>
        <p>
          Bakely follows a standard procedure of using log files. These files log visitors when they visit websites.
        ...
        <p>
          Like any other website, Bakely uses 'cookies'. These cookies are used to store information including visitors'
        ...
        <p>
          You may consult this list to find the Privacy Policy for each of the advertising partners of Bakely.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used
          in
          their respective advertisements and links that appear on Bakely, which are sent directly to users' browser.
          They
        ...
        <p>
          Note that Bakely has no access to or control over these cookies that are used by third-party advertisers.
        </p>
        <h3>Third Party Privacy Policies</h3>
        <p>
          Bakely's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult
          the
        ...
        <p>
          Bakely does not knowingly collect any Personal Identifiable Information from children under the age of 13. If
          you
