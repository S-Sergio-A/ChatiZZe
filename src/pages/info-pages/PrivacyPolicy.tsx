  ...
  return (
    <main id="main" className="info-page grid">
      ...
      <section className="t-b flex j-c-c a-i-c">
        <h1>{t("infoPages.privacy.header")}</h1>
      </section>
      <article className="m-b flex j-c-s-b a-i-f-s f-f-c-n">
        <p>
          At Chatterly, accessible from <a href="https://www.chatterly.top">https://www.chatterly.top</a>, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Chatterly and
          how we use it.
        </p>
        ...
        <p>
          ...
          that they shared and/or collect in Chatterly. This policy is not applicable to any information collected offline or via channels
          other than this website. Our Privacy Policy was created with the help of the
          <a target="_blank" rel="nofollow noreferrer" href="https://www.privacypolicygenerator.info">
            Privacy Policy Generator
          </a>
          and the
          <a target="_blank" rel="nofollow noreferrer" href="https://www.generateprivacypolicy.com/#wizard">
        ...
        <h3>Log Files</h3>
        <p>
          Chatterly follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies
          do this and a part of hosting services' analytics. The information collected by log files include internet protocol (IP)
        ...
        <p>
          Like any other website, Chatterly uses 'cookies'. These cookies are used to store information including visitors' preferences, and
        ...
        <p>
          ...
          <a target="_blank" rel="nofollow noreferrer" href="https://www.cookieconsent.com/what-are-cookies/">
            "What Are Cookies" from Cookie Consent
          </a>
          .
        </p>
        <h3>Advertising Partners Privacy Policies</h3>
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Chatterly.</p>
        <p>
          ...
          advertisements and links that appear on Chatterly, which are sent directly to users' browser. They automatically receive your IP
        ...
        <p>Note that Chatterly has no access to or control over these cookies that are used by third-party advertisers.</p>
        <h3>Third Party Privacy Policies</h3>
        <p>
          Chatterly's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective
        ...
        <p>
          Chatterly does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your
          child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our
