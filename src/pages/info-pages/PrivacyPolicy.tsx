  ...
  return (
    <main id="main" className="info-page grid">
      ...
      <article className="m-b flex j-c-s-b a-i-f-s f-f-c-n">
        <p>
          At Bakely, accessible from <a href="https://www.chatizze.com">https://www.chatizze.com</a>, one of our main priorities is the
          privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Bakely and
          how we use it.
        </p>
