...
class ErrorBoundary extends Component {
  ...
  render() {
    ...
    if (this.state.hasError) {
      return (
        <main id="main" className="error-page grid">
          <Head
          ...
          <div className="m-b flex j-c-s-a a-i-c f-f-c-n">
            <svg className="svg" xmlns="http://www.w3.org/2000/svg" width="1119.60911" height="699" viewBox="0 0 1119.60911 699">
              <title>{t("errorBoundary.header")}</title>
              ...
              <rect x="271.60911" y="150" width="16" height="16" fill="#7400b8" opacity="0.4" />
              <rect x="294.60911" y="150" width="16" height="16" fill="#7400b8" opacity="0.8" />
              <rect x="317.60911" y="150" width="16" height="16" fill="#7400b8" />
              <rect x="271.60911" y="251" width="16" height="16" fill="#7400b8" opacity="0.4" />
              <rect x="294.60911" y="251" width="16" height="16" fill="#7400b8" opacity="0.8" />
              <rect x="317.60911" y="251" width="16" height="16" fill="#7400b8" />
              <rect x="271.60911" y="352" width="16" height="16" fill="#7400b8" opacity="0.4" />
              <rect x="294.60911" y="352" width="16" height="16" fill="#7400b8" opacity="0.8" />
              <rect x="317.60911" y="352" width="16" height="16" fill="#7400b8" />
