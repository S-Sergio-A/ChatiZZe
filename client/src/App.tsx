...
const App = () => {
  ...
  async function invoke() {
    ...
    await axios.get("https://chatty-messages.herokuapp.com").catch((e) => logError(e));
    await axios.get("https://chatty-verification.herokuapp.com").catch((e) => logError(e));
    await axios.get("https://chatty-rooms.herokuapp.com").catch((e) => logError(e));
    await axios.get("https://chatty-auth.herokuapp.com").catch((e) => logError(e));
  }
