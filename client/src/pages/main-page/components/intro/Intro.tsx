  ...
  return (
    <section className="intro grid">
      ...
      <div className={`flex a-i-c j-c-s-b ${width < 481 ? "f-f-c-n" : "f-f-r-n"}`}>
        <a href="#some-link-to-app-store">
          <img
            ...
            src="https://res.cloudinary.com/gachi322/image/upload/v1628535190/chatty/app-store-badge_ik5o6k.png"
        ...
        <a href="#some-link-to-google-play">
          <img
            className="btn-sm-x-w"
            src="https://res.cloudinary.com/gachi322/image/upload/v1628535189/chatty/google-play-badge_sso7hp.png"
      ...
      <img
        ...
        src="https://res.cloudinary.com/gachi322/image/upload/v1628535190/chatty/intro-chat-r-min_ezvnhz.png"
