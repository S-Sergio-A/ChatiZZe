  ...
  return (
    <section className="how-it-works grid">
      <header className="f-w flex a-i-c j-c-c">
        <h2 className={`${width < 769 ? "h4-s f-w__900" : "h1-s"}`}>{t("main.how_w.header")}</h2>
      </header>
      <div className="col grid">
        <div className="flex f-f-c-n">
          ...
          <p className="t-j h6-s">{t("main.how_w.step_o")}</p>
        </div>
        <div className="flex f-f-c-n">
          <header>
            <h4>
          ...
          <p className="t-j h6-s">{t("main.how_w.step_t")}</p>
        </div>
        <div className="flex f-f-c-n">
          <header>
            <h4>
          ...
          <p className="t-j h6-s">{t("main.how_w.step_th")}</p>
        </div>
        <div className="flex f-f-c-n">
          <header>
            <h4>
          ...
          <p className="t-j h4-s f-w__900">{t("main.how_w.step_f")}</p>
        </div>
      </div>
      <div className="col flex a-i-c j-c-f-s f-f-c-n">
        <figure className="f-w flex a-i-c j-c-c f-f-c-n">
          <video
            ...
            controls
            preload="metadata"
            poster="https://res.cloudinary.com/gachi322/image/upload/v1628535189/chatty/chat-demo-r-min_xedstv.png"
          />
          <figcaption className="flex a-i-c j-c-s-b">
            ...
            <span className={`${width < 481 ? "h6-s" : ""}`}>{t("main.how_w.check_demo")}</span>
          </figcaption>
        </figure>
      </div>
    </section>
