  ...
  return (
    <main id="main" className="contact-page grid">
      ...
      <header className="t-b flex j-c-c a-i-c f-f-c-n">
        ...
        <a href="mailto:sales@chatty.com" className="h6-s Secondary-Link">
          sales@chatty.com
        </a>
      </header>
        ...
        <form className="form f-w flex a-i-c j-c-c f-f-c-n" method="POST">
          ...
          <div className="ta-r">
            ...
            <textarea
              ...
              required
            />
            <p className={contactFormError.messageError ? "form-l-e it flex a-s-f-s f-w copyright" : "none"}>
              {contactFormError.messageError ? contactFormError.messageError : null}
            </p>
          </div>
        </form>
