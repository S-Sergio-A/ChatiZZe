  ...
  return (
    <main id="main" className="info-page grid">
      ...
      <article className="m-b flex j-c-s-b a-i-f-s f-f-c-n">
        <p>
          At Bakely, accessible from <a href="https://www.chatty.com">https://www.chatty.com</a>, one of our main priorities is the privacy
          of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Bakely and how we
          use it.
        </p>
        ...
        <p>
          ...
          that they shared and/or collect in Bakely. This policy is not applicable to any information collected offline or via channels
        ...
        <h3>Log Files</h3>
        <p>
          Bakely follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies
        ...
        <p>
          Like any other website, Bakely uses 'cookies'. These cookies are used to store information including visitors' preferences, and
        ...
        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of Bakely.</p>
        <p>
          ...
          advertisements and links that appear on Bakely, which are sent directly to users' browser. They automatically receive your IP
        ...
        <p>Note that Bakely has no access to or control over these cookies that are used by third-party advertisers.</p>
        <h3>Third Party Privacy Policies</h3>
        <p>
          Bakely's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective
        ...
        <p>
          Bakely does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your
